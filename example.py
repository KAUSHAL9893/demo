print("exp3:::•	Create a GitHub account if you don't already have one.  
...
Continuous Integration and Continuous Deployment (CI/CD) with Jenkins is a powerful way to automate the building, testing, and deployment of your software projects. In this example, I'll walk you through setting up a simple Jenkins pipeline for a Java application hosted on a GitHub repository. This pipeline will automate the build and deployment process whenever changes are pushed to the repository.
")
